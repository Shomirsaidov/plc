...
class CarController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $message = "New car added ! ID : <strong>" . $car->id . "</strong>";
        ...
        return redirect()->route('cars.show', ['id' => $car->id])->with('success', 'Автомобиль успешно добавлен!');
    }
